...
import { ReportRoutes } from './reports/presentation/report.routes';
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./layout/presentation/pages/groupware/groupware.component'),
      },
      {
        path: 'info',
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./chat/presentation/pages/chat-layout/chat-layout.component'),
      },
    ],
  },
